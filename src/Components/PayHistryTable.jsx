...
const PayHistryTable = ({ index, item, handleDelete }) => {
    ...
    return (
        <tr className=" shadow text-gray-200 border">
            ...
            <td
                className="shadow text-gray-200 border text-center"
                style={{ cursor: "pointer" }}
            >
                {item.pen_amount}.00 TK
            </td>
            <td className="shadow text-gray-200 border text-center">{item.exdate}</td>
            <td className="shadow text-gray-200 border text-center">{item.date}</td>
