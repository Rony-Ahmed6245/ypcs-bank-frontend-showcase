    ...
    return (
        <div className="max-w-7xl mx-auto p-4 my-2 ">
            ...
            <div className="md:flex justify-start items-start gap-2">
                <div className="grid grid-cols-2 border-[2px] shadow-lg border-blue-700  text-center my-2 w-full p-4 rounded ">

                    {/* <p className="text-md  uppercase border  text-gray-200  font-bold bg-blue-600  p-5 shadow  rounded">একাউন্ট নম্বর: {acc_no}</p> */}
                    <p className="text-md border-r-2 border-r-blue-800  font-bold"> সর্বমোট জমাকৃত <br /> <span className="text-green-600 font-bold"> {totalAmount}</span>  ‍টাকা।</p>
                    <p className="text-md font-bold">সর্বমোট জরিমানা <br /> 
                    <span className="text-red-600 font-bold">{penaltyAmount}</span> টাকা।</p>
                </div>
