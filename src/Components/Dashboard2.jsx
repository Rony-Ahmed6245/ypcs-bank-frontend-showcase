        ...
        <div>
            <div className=" ">
                <div className="grid grid-cols-2 md:grid-cols-6  max-w-5xl mx-auto gap-2 mt-0 py-4  mb-10">
                    ...
                    <Link className="bg-white border shadow-md hover:text-white text-black py-1 md:px-4 px-2 rounded-md mx-1 font-semibold text-center text-sm md:text-md hover:bg-gradient-to-r from-[#711DB0] to-[#ED0B5A] transition-all uppercase flex justify-center items-center gap-1" to={'/dashboard/newAccount'}><MdAccountCircle />নতুন একাউন্ট খুলুন</Link>
                    <Link className="bg-white border shadow-md hover:text-white text-black py-1 md:px-4 px-2 rounded-md mx-1 font-semibold text-center text-sm md:text-md hover:bg-gradient-to-r from-[#711DB0] to-[#ED0B5A] transition-all uppercase flex justify-center items-center gap-1" to={'/dashboard/manageAcc'}><MdManageAccounts />সকল একাউন্ট</Link>
                    <Link className="bg-white border shadow-md hover:text-white text-black py-1 md:px-4 px-2 rounded-md mx-1 font-semibold text-center text-sm md:text-md hover:bg-gradient-to-r from-[#711DB0] to-[#ED0B5A] transition-all uppercase flex justify-center items-center gap-1" to={'/dashboard/dp'}><IoIosAddCircleOutline />টাকা জমাদিন</Link>
                    <Link className="bg-white border shadow-md hover:text-white text-black py-1 md:px-4 px-2 rounded-md mx-1 font-semibold text-center text-sm md:text-md hover:bg-gradient-to-r from-[#711DB0] to-[#ED0B5A] transition-all uppercase flex justify-center items-center gap-1" to={'/dashboard/pay'}><AiOutlineHistory />জমার সকল হিস্টোরি</Link>
                    <Link className="bg-white border shadow-md hover:text-white text-black py-1 md:px-4 px-2 rounded-md mx-1 font-semibold text-center text-sm md:text-md hover:bg-gradient-to-r from-[#711DB0] to-[#ED0B5A] transition-all uppercase flex justify-center items-center gap-1" to={'/dashboard/guide'}><TiMail />গাইড</Link>
                </div>
            </div>
